...
public class iletisimBilgActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iletisim_bilg);
        ...
        LinearLayout linearLayout2 = (LinearLayout) findViewById(R.id.linearVerticaliletisim);
        ...
        for (i = 0; i < personelBilgileri.size(); i++) {
            ...
            textView4.setText(personelBilgileri.get(i).getAdres().toString());


            TextView textView5 = new TextView(this);
            textView5.setText(personelBilgileri.get(i).getCepNumarasi().toString());


            TextView textView6 = new TextView(this);
            textView6.setText(personelBilgileri.get(i).getEvNumarasi().toString());


            TextView textView7 = new TextView(this);
            textView7.setText(personelBilgileri.get(i).getEmail().toString());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_iletisim_bilg, menu);
        return true;
    }
