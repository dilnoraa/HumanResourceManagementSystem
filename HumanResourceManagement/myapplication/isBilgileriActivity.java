...
public class isBilgileriActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_is_bilgileri);

        mydb=new DatabaseHelper(this);

        ArrayList<personelClass> personelBilgileri = (ArrayList<personelClass>) mydb.getPersonelBilgiler();

        LinearLayout linearLayout2 = (LinearLayout) findViewById(R.id.linearVerticalis);
        ...
        for (i = 0; i < personelBilgileri.size(); i++) {
            ...
            textView4.setText(personelBilgileri.get(i).getDepartman().toString());


            TextView textView5 = new TextView(this);
            textView5.setText(personelBilgileri.get(i).getPozisyon().toString());


            TextView textView6 = new TextView(this);
            textView6.setText(personelBilgileri.get(i).getMaas().toString());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_is_bilgileri, menu);
        return true;
    }
