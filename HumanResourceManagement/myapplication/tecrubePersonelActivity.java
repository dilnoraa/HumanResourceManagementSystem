...
public class tecrubePersonelActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tecrube_personel);
        ...
        LinearLayout linearLayout4 = (LinearLayout) findViewById(R.id.linearVerticalTecrubePersonel);
        ...
        for (i = 0; i < personelBilgileri.size(); i++) {
            ...
            ArrayList<TecrubeSinif> tBilgileri = (ArrayList<TecrubeSinif>) mydb.getAlltecrubePersonelbyId(sicil);
            if(tBilgileri.size()>0) {
               ...
               TextView textView1 = new TextView(this);
                ...
                linearLayout4.addView(lh, lh_yerlesim);


                for(int j=0; j<tBilgileri.size();j++) {
                    ...
                    textView4.setText(tBilgileri.get(j).getSirketAdi().toString());


                    TextView textView5 = new TextView(this);
                    textView5.setText(tBilgileri.get(j).getPozisyon().toString());


                    TextView textView6 = new TextView(this);
                    textView6.setText(tBilgileri.get(j).getBaslamatarih().toString());


                    TextView textView7 = new TextView(this);
                    textView7.setText(tBilgileri.get(j).getBitistarih().toString());
                    ...
                    linearLayout4.addView(lh2, lh_yerlesim);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tecrube_personel, menu);
        return true;
    }
